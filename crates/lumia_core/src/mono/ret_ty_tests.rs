    ...
    fn merge_slot_ty_heap_beats_float() {
        ...
        assert_eq!(
            merge_slot_ty(Some(Type::Char), Type::Float),
            Type::Char
        );
        assert_eq!(
            merge_slot_ty(Some(Type::Float), Type::Char),
            Type::Char
        );
        assert_eq!(
            merge_slot_ty(Some(Type::String), Type::Float),
            Type::String
        );
        assert_eq!(
    ...
    fn join_fixed_float_beats_string_and_bool() {
        use super::join_fixed_ty;
        assert_eq!(
            join_fixed_ty(&Type::String, &Type::Float),
            Some(Type::Float)
        );
        assert_eq!(
            join_fixed_ty(&Type::Float, &Type::Bool),
            Some(Type::Float)
        );
        assert_eq!(
            join_fixed_ty(&Type::Char, &Type::Float),
            Some(Type::Float)
        );
    }
