...
//!
//! These are **not** [`lumi_hir::Builtin`] variants: they are surface names in
//! [`lumi_hir::PRELUDE_CTORS`], inferred here, and lowered to Core `AllocList` /
//! `AllocSet` / `AllocMap` (see `lumi_core::lower`). Keep arity/effect handling
