...
echo "== build =="
"$LUMIA" build --release examples/bench/bench_cn_step_kernel.lm -o "$OUT_DIR/kernel"
"$LUMIA" build --release --no-dense-f64-sr examples/bench/bench_cn_step_naive.lm -o "$OUT_DIR/naive"
