...
echo "== build =="
"$LUMIA" build --release examples/bench/bench_cn_strict_kernel.lm -o "$OUT_DIR/kernel"
"$LUMIA" build --release examples/bench/bench_cn_strict_naive.lm -o "$OUT_DIR/naive"
